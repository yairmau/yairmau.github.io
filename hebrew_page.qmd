...
<span class="iconify" data-icon="bi:person-circle"></span> **מרצה בכיר**  
<span class="iconify" data-icon="icomoon-free:leaf" data-rotate="270deg"></span> **המכון למדעי הסביבה**  
 <img class="invert" src="archive/images/huji-gray-transparent.png" width="18" style='vertical-align:top;' align="right"> &nbsp; **האוניברסיטה העברית בירושלים**
::::

:::

## יצירת קשר
<i class="fas fa-envelope fa-fw fa-lg svv" aria-hidden="true"></i> <span>&ensp;</span> <bdi dir="ltr">yair.mau@mail.huji.ac.il</bdi>   
<i class="fa-solid fa-phone fa-fw fa-lg svv"></i>
<span>&ensp;</span> <bdi dir="ltr">+972 8 948 9386</bdi>  
<i class="fas fa-map-marked-alt fa-fw fa-lg svv"></i> <span>&ensp;</span> קמפוס רחובות, בניין לובל, משרד 19. <a href="https://goo.gl/maps/DM62y5VXAxJ2" target="_blank">קישור למפה</a>
...
אפשר לקרוא עוד על כמה מהפרויקטים הנוכחיים שלי ב[{{< fa compass-drafting >}} עמוד המחקר](/science.html), ולמצוא פרטים על עבודות שכבר פורסמו ב[{{< fa file >}} עמוד המאמרים](/papers.html).

מלבד העמודים האקדמיים הרגילים (מחקר, מאמרים, קבוצת המחקר וקורסים), החבאתי הרבה חומר ב[{{< fa magnifying-glass-plus >}} עמוד ״עוד״](/more): מדריכים (Python, LaTeX), ציטוטים, המלצות ועוד.
