...
<iframe width="560" height="315" src="https://www.youtube.com/embed/Hq00HjbeiX8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div>
...
In order to make photosynthesis, plants capture CO2 from the atmosphere through the pores in their leaves (stomata).
However, at the same time that CO2 enters the plant, water vapor exits.
If too much water leaves the plant, it will desiccate and die, so the plant should keep its stomata mostly closed.
On the other hand, the plant will starve from lack of carbon if it doesn't open its stomata.
We apply the tools of optimal control theory to study this fascinating problem.
