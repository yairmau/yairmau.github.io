...
::: authors
[[Oded]{property="givenName"}
[Hollander]{property="familyName"}[https://orcid.org/0009-0009-0484-2962](https://orcid.org/0009-0009-0484-2962){.orcid-id
property="identifier"
aria-label="ORCID identifier"}^[^1],[^2]^]{property="author"
typeof="Person"}, [[Yair]{property="givenName"}
[Mau]{property="familyName"}[https://orcid.org/0000-0001-6987-7597](https://orcid.org/0000-0001-6987-7597){.orcid-id
property="identifier"
aria-label="ORCID identifier"}^[^3],[^4],[^5]^]{property="author"
typeof="Person"}, and [[Niv]{property="givenName"}
[DeMalach]{property="familyName"}[https://orcid.org/0000-0002-4509-5387](https://orcid.org/0000-0002-4509-5387){.orcid-id
property="identifier"
aria-label="ORCID identifier"}^[^6],[^7],[^8]^]{property="author"
typeof="Person"}
:::
...
::: {.citation .long}
[August 25,
2026]{property="datePublished"}[[[123]{property="volumeNumber"}]{property="isPartOf"
typeof="PublicationVolume"}
([[35]{property="issueNumber"}]{property="isPartOf"
typeof="PublicationIssue"}) [e2615937123]{property="identifier"
typeof="Text"}]{.core-enumeration}[[https://doi.org/10.1073/pnas.2615937123](https://doi.org/10.1073/pnas.2615937123){property="sameAs"}]{.doi}
:::

:::: {#index.xhtml_executive-summary-abstract .section .simple .abstract property="abstract" typeof="Text" role="doc-abstract"}
## Significance {property="name"}
...
[Stress Gradient Hypothesis]{.keyword} │ [aridity gradient]{.keyword}
│ [precipitation]{.keyword} │ [plant--plant interactions]{.keyword}
│ [consumer--resource model]{.keyword}
:::
...
University of Jerusalem, Rehovot 76100001, Israel]{#index.xhtml_aff1
property="name"}
:::

::: {property="affiliation" typeof="Organization"}
^b^[Department of Soil and Water Sciences, Institute of Environmental
Sciences, Robert H. Smith Faculty of Agriculture, Food and Environment,
The Hebrew University of Jerusalem, Rehovot 76100001,
Israel]{#index.xhtml_aff2 property="name"}
:::
:::::
...
:::::::::: article-notes
::: core-supplementary-link
This article contains supporting information online at
<https://doi.org/10.1073/pnas.2615937123#supplementary-materials>.
:::

:::::: author-notes
::::: {role="doc-footnote" has="label"}
::: label
2
:::

::: {#index.xhtml_cor1 role="paragraph"}
To whom correspondence may be addressed. Email:
<yair.mau@mail.huji.ac.il> or <niv.demalach@mail.huji.ac.il>.
:::
:::::
::::::
...
::: {data-type="flushleft" role="paragraph"}
...
<figure id="fig01" class="graphic figure" epub:type="figure">
<a href="fig01.xhtml"><img
src="./images/images/large/pnas.2615937123fig01.jpg"
style="width: min(100%,500px);" data-height="1005" data-width="2125"
alt="A three-panel figure. Panel A and B show canopy and root mechanisms using tree diagrams and line graphs. Panel C is a multi-line biomass graph." /></a>
<figcaption><span class="heading">Fig. 1</span>. Focal assumptions of
the two submodels (<em>A</em> and <em>B</em>) and potential model
outcomes (<em>C</em>). (<em>A</em>) The canopy mechanism represent the
...
necessary condition for facilitation under shading). (<em>B</em>) root
...
and increases moisture in shallow soil. The curve <span
role="math"><span
class="math inline"><em>f</em><sub><em>r</em></sub>(<em>S</em>)</span></span>
shows the net effect of these two opposing processes across the full
range of soil water content (<span role="math"><span
class="math inline"><em>S</em> ∈ [0, 1]</span></span>) as assumed in the
...
so net uptake is negative (<span role="math"><span
class="math inline"><em>f</em><sub><em>r</em></sub>(<em>S</em>) &lt; 0</span></span>;
dark blue), meaning the tree is a net supplier of water to the upper
soil. At intermediate moisture, uptake becomes more efficient and
overtakes hydraulic lift, shifting <span role="math"><span
class="math inline"><em>f</em><sub><em>r</em></sub>(<em>S</em>)</span></span>
to positive values (light blue). At high soil moisture, net uptake
saturates at its maximum. (<em>C</em>) Potential model outcomes are
...
::::::::::::::::::::: {#index.xhtml_sec-1 .section data-type="results"}
## Results
...
:::::: {#index.xhtml_eqn2 .display-formula}
:::: {.equation role="math"}
::: inner
$$\begin{array}{rlr}
{\mathbf{herb}\mspace{6mu}\mathbf{biomass}:} & \frac{\mathit{dB}}{\mathit{dt}} & {= \overset{\text{growth}}{\overbrace{a\, f_{a}{(d)}\, f_{k}{(B)}B\, S}} - \overset{\text{mortality}}{\overbrace{m\, B}}}
\end{array}$$
:::
::::
...
:::::: {#index.xhtml_eqn3 .display-formula}
:::: {.equation role="math"}
::: inner
$$\begin{array}{rlr}
{\mathbf{soil}\mspace{6mu}\mathbf{water}:} & {\underset{\begin{matrix}
\text{active} \\
\text{soil depth}
\end{matrix}}{\underbrace{nz_{r}}}\frac{\mathit{dS}}{\mathit{dt}}} & {= \underset{\text{precipitation}}{\underbrace{p}} - \underset{\text{drainage}}{\underbrace{q_{s}S^{c}}} - \underset{\text{evapotranspiration}}{\underbrace{e_{0}\, f_{e}{(d)}B\, S}} - \underset{\text{tree root}}{\underbrace{f_{r}{(S,d)}}}.}
\end{array}$$
:::
::::
...
([$B$]{role="math"}) over time, which is governed by growth and
mortality processes. The second equation represents the dynamics of soil
moisture ([$S$]{role="math"}), which is influenced by gains from
precipitation ([$p$]{role="math"}) and losses due to drainage,
...
([$d$]{role="math"} representing canopy cover or root density). This
parameter affects both the canopy-suppression factors on herb growth
([$f_{a}{(d)}$]{role="math"}) and on evapotranspiration
([$f_{e}{(d)}$]{role="math"}), as depicted in [Fig. 1*A*](fig01.xhtml).
In the main model, tree density [$d$]{role="math"} is fixed to isolate
the immediate resource-mediated mechanisms. We relax this assumption in
[*SI Appendix*, section
S1](https://www.pnas.org/doi/10.1073/pnas.2615937123#supplementary-materials),
by considering precipitation-dependent woody cover. The impact of the
root mechanism [$f_{r}{(S,d)}$]{role="math"} on soil water is depicted
in [Fig. 1*B*](fig01.xhtml). We further assumed that when water and
...
[$f_{k}{(B)} = 1 - B/k$]{role="math"}. For simplicity, we started by
...
[$f_{k}{(B)}$]{role="math"}) is a necessary condition for the transition
to occur ([*SI Appendix*, section
S2](https://www.pnas.org/doi/10.1073/pnas.2615937123#supplementary-materials)).
...
S3](https://www.pnas.org/doi/10.1073/pnas.2615937123#supplementary-materials).
:::
...
decreases (black line in [Fig. 2*A*](fig02.xhtml)). With some trees
...
<figure id="fig02" class="graphic figure" epub:type="figure">
<a href="fig02.xhtml"><img
src="./images/images/large/pnas.2615937123fig02.jpg"
style="width: min(100%,500px);" data-height="711" data-width="1017"
alt="Four-panel figure A, B, C, and D showing biomass and soil water content versus precipitation for canopy and root mechanisms at d=0.0, 0.4, and 0.9." /></a>
<figcaption><span class="heading">Fig. 2</span>. The transition from
facilitation to competition can be produced by both shading and
hydraulic lift. Herb biomass and soil water solutions of Eq. <a
href="#index.xhtml_eqn2"><strong>1</strong></a> are shown for the canopy
mechanism (<em>A</em> and <em>C</em>) and the root mechanism (<em>B</em>
and <em>D</em>). Black lines give the no-tree baseline (<span
role="math"><span class="math inline"><em>d</em> = 0</span></span>),
light solid curves show moderate tree density (<span role="math"><span
class="math inline"><em>d</em> = 0.4</span></span>) and dark solid
curves high tree density (<span role="math"><span
class="math inline"><em>d</em> = 0.9</span></span>). Facilitation
(competition) occurs when the herb biomass solid curves are above
(below) the baseline curve. Other parameter values are as reported in <a
href="t01.xhtml">Table 1</a>.</figcaption>
</figure>
...
is represented by the function [$f_{e}{(d)}$]{role="math"}, leading to
greater soil water availability relative to a no-tree environment ([Fig.
2*C*](fig02.xhtml)). Second, trees inhibit herb growth by reducing light
availability through the function [$f_{a}{(d)}$]{role="math"}. This
factor, along with other limiting elements (captured by the carrying
capacity term, [$f_{k}{(B)}$]{role="math"}), down-regulates herb
assimilation. The combined effect is represented by the product
[$f_{a}{(d)}f_{k}{(B)}$]{role="math"}.
:::

::: {role="paragraph"}
At low precipitation, herb biomass is low, so the carrying capacity term
[$f_{k}{(B)}$]{role="math"} is very weak (close to 1). In this dry
scenario, the tug of war is mainly between the water-saving benefit of
[$f_{e}{(d)}$]{role="math"} and the assimilation reduction effect of
[$f_{a}{(d)}$]{role="math"}. When tree density is low, the extra soil
water overpowers the minor loss in assimilation, facilitating herb
growth (light curve in [Fig. 2*A*](fig02.xhtml)). However, when tree
...
[$f_{k}{(B)}$]{role="math"} (making it closer to zero) and tips the
balance. The combined competitive effect of reduced assimilation and
carrying capacity ([$f_{a}{(d)}f_{k}{(B)}$]{role="math"}) becomes
...
precipitation and lower at high precipitation ([Fig.
2*B*](fig02.xhtml)). As tree density increases, both effects intensify
...
[$f_{r}{(S,d)}$]{role="math"}, which represents the net effect of tree
...
[$f_{r}{(S,d)}$]{role="math"} by itself does not produce a
facilitation-to-competition switch ([*SI Appendix*, section
S2](https://www.pnas.org/doi/10.1073/pnas.2615937123#supplementary-materials)).
With water as the only limiting resource (i.e.,
[$f_{k}{(B)} = 1$]{role="math"}), the equilibrium soil moisture
[$S^{\star}$]{role="math"} is set by the consumer and is independent of
the precipitation supply [$p$]{role="math"} \[R\* logic
([33](#index.xhtml_r33){.biblioref role="doc-biblioref"
xml-rid="r33"})\]. Because [$f_{r}$]{role="math"} acts through
[$S$]{role="math"} rather than directly through [$p$]{role="math"}, the
sign of the interaction is fixed by whether [$S^{\star}$]{role="math"}
...
[$f_{k}{(B)}$]{role="math"}, the outcome changes: As [$p$]{role="math"}
increases, biomass approaches its limit and cannot deplete water
further, so [$S^{\star}$]{role="math"} rises. This upward shift in
[$S^{\star}$]{role="math"} carries the system across the hydraulic
threshold, turning facilitative lift into competitive uptake and
yielding the observed transition. Put simply,
[$f_{k}{(B)}$]{role="math"} caps biomass at high rainfall, weakening
consumption and allowing soil water to accumulate, which moves
[$S^{\star}$]{role="math"} into the competitive domain of
[$f_{r}{(S,d)}$]{role="math"}.
:::
...
in [Fig. 2*A*](fig02.xhtml), respectively). This facilitative gap
...
absolute difference is unimodal ([Fig. 3*A*](fig03.xhtml)). This pattern
...
ratio ([Fig. 3*C*](fig03.xhtml)), the interaction intensity decreases
monotonically for [$p$]{role="math"} below the transition threshold. In
...
mechanism's interaction intensity in the full [$(p,d)$]{role="math"}
parameter space is given in [*SI Appendix*, section
S4](https://www.pnas.org/doi/10.1073/pnas.2615937123#supplementary-materials).
:::

<figure id="fig03" class="graphic figure" epub:type="figure">
<a href="fig03.xhtml"><img
src="./images/images/large/pnas.2615937123fig03.jpg"
style="width: min(100%,500px);" data-height="711" data-width="1025"
alt="Four-panel figure shows interaction intensity versus precipitation. Panels A and C show canopy mechanism; B and D show root mechanism." /></a>
<figcaption><span class="heading">Fig. 3</span>. Interaction intensity
patterns depend on both mechanism and metric. The gray lines represent
zero interaction. Positive interactions indicate facilitation by trees;
negative interactions indicate competition. Panels (<em>A</em> and
<em>B</em>) show the absolute interaction intensity, <span
role="math"><span
class="math inline"><em>B</em><sub><em>T</em></sub> − <em>B</em><sub>0</sub></span></span>,
where <span role="math"><span
class="math inline"><em>B</em><sub>0</sub></span></span> and <span
role="math"><span
class="math inline"><em>B</em><sub><em>T</em></sub></span></span> denote
herb biomass in the absence and presence of tree density, respectively.
Panels (<em>C</em> and <em>D</em>) show the relative log response ratio,
<span role="math"><span
class="math inline">ln (<em>B</em><sub><em>T</em></sub>/<em>B</em><sub>0</sub>)</span></span>.
Parameters: <span role="math"><span
class="math inline"><em>d</em> = 0.0</span></span> and <span
role="math"><span class="math inline"><em>d</em> = 0.4</span></span>
were used to compute <span role="math"><span
class="math inline"><em>B</em><sub>0</sub></span></span> and <span
role="math"><span
class="math inline"><em>B</em><sub><em>T</em></sub></span></span>,
respectively; other parameters are given in <a href="t01.xhtml">Table
1</a>.</figcaption>
</figure>
:::::::::::::::::::::

:::::::::::::::::::::::::: {#index.xhtml_sec-2 .section data-type="discussion"}
## Discussion
...
S5](https://www.pnas.org/doi/10.1073/pnas.2615937123#supplementary-materials)).
:::
...
([*SI Appendix*, section
S6](https://www.pnas.org/doi/10.1073/pnas.2615937123#supplementary-materials)).
...
section
S7](https://www.pnas.org/doi/10.1073/pnas.2615937123#supplementary-materials)).
:::
...
S8](https://www.pnas.org/doi/10.1073/pnas.2615937123#supplementary-materials)).
...
section
S9](https://www.pnas.org/doi/10.1073/pnas.2615937123#supplementary-materials)
which shows that carrying capacity is equivalent to an additional
...
S1](https://www.pnas.org/doi/10.1073/pnas.2615937123#supplementary-materials)).
This occurs because at high tree cover, light becomes the primary
...
section
S10](https://www.pnas.org/doi/10.1073/pnas.2615937123#supplementary-materials)).
:::
:::::::::

:::::: {#index.xhtml_sec-2-2 .section}
### Root Mechanisms.
...
Appendix*, section
S11](https://www.pnas.org/doi/10.1073/pnas.2615937123#supplementary-materials)).
:::
::::::

:::::::: {#index.xhtml_sec-2-3 .section}
### Concluding Remarks.
...
:::::::::::::::::::::: {#index.xhtml_sec-3 .section data-type="methods"}
## Methods

::: {data-type="flushleft" role="paragraph"}
We developed a consumer--resource model (Eq. [**1**](#index.xhtml_eqn2))
that describes the dynamics of herbaceous biomass density
([$B$]{role="math"}, gm^−1^) ([36](#index.xhtml_r36){.biblioref
role="doc-biblioref" xml-rid="r36"}, [37](#index.xhtml_r37){.biblioref
role="doc-biblioref" xml-rid="r37"}), and relative soil-water content
([$S$]{role="math"}, dimensionless) ([65](#index.xhtml_r65){.biblioref
...
[$f_{a}{(d)}$]{role="math"}, while additional nonfocal constraints, such
as nutrients, pathogens, or self-shading within the herbaceous layer,
are represented phenomenologically by [$f_{k}{(B)}$]{role="math"} ([*SI
Appendix*, sections S5 and
S9](https://www.pnas.org/doi/10.1073/pnas.2615937123#supplementary-materials)).
:::

::: {role="paragraph"}
The dynamics of herbaceous biomass density [$B$]{role="math"} are
governed by growth and mortality terms (Eq.
[**1a**](#index.xhtml_eqn2)). The dynamics of relative soil-water
content [$S$]{role="math"} are dictated by a water-balance equation
...
(Eq. [**1b**](#index.xhtml_eqn2)). Herb biomass and water are averaged
over the horizontal dimensions, and water is averaged over the active
soil depth [$nz_{r}$]{role="math"}, following a traditional bucket-model
...
::: {role="paragraph"}
The functions
[$f_{a}{(d)},f_{k}{(B)},f_{e}{(d)},f_{r}{(S,d)}$]{role="math"} are
...
dependent on soil water content [$S$]{role="math"} (when the carrying
...
soil moisture availability, following a linear [$\beta$]{role="math"}
function of [$S$]{role="math"} ([67](#index.xhtml_r67){.biblioref
...
v) The logistic growth term [$f_{k}{(B)} = 1 - B/k$]{role="math"} was
used throughout this paper and was only turned off
([$f_{k}{(B)} = 1$]{role="math"}) in [*SI Appendix*, sections S1 and
S2](https://www.pnas.org/doi/10.1073/pnas.2615937123#supplementary-materials),
where we studied the effects of removing additional growth-limiting
...
[$p$]{role="math"} is understood as the total precipitation of the
growing season divided by its duration; it is reported in mm instead of
mmd^−1^ throughout the paper to enhance interpretability.
:::
...
<td data-xml-align="left"><span role="math"><span
class="math inline"><em>B</em></span></span></td>
<td>gm<sup>−1</sup></td>
<td><span role="math"><span class="math inline">0</span></span> to
1,000</td>
...
<tr data-xml-align="center">
<td data-xml-align="left"><span role="math"><span
class="math inline"><em>S</em></span></span></td>
<td>—</td>
<td><span role="math"><span class="math inline">0</span></span> to <span
role="math"><span class="math inline">1</span></span></td>
...
<tr data-xml-align="center">
<td data-xml-align="left"><span role="math"><span
class="math inline"><em>a</em></span></span></td>
<td>d<sup>−1</sup></td>
<td><span role="math"><span class="math inline">0.05</span></span></td>
<td>Assimilation rate (<a href="#index.xhtml_r74" class="biblioref"
role="doc-biblioref" data-xml-rid="r74">74</a>)</td>
</tr>
<tr data-xml-align="center">
<td data-xml-align="left"><span role="math"><span
class="math inline"><em>β</em><sub><em>a</em></sub></span></span></td>
<td>—</td>
<td><span role="math"><span class="math inline">1/3</span></span></td>
...
<tr data-xml-align="center">
<td data-xml-align="left"><span role="math"><span
class="math inline"><em>β</em><sub><em>e</em></sub></span></span></td>
<td>—</td>
<td><span role="math"><span class="math inline">4</span></span></td>
<td>Shading function exponent (<a href="#index.xhtml_r49"
class="biblioref" role="doc-biblioref" data-xml-rid="r49">49</a>–<a
href="#index.xhtml_r51" class="biblioref" role="doc-biblioref"
data-xml-rid="r51">51</a>)</td>
...
<tr data-xml-align="center">
<td data-xml-align="left"><span role="math"><span
class="math inline"><em>k</em></span></span></td>
<td>gm<sup>−1</sup></td>
<td><span role="math"><span class="math inline">1000</span></span></td>
<td>Carrying capacity (<a href="#index.xhtml_r75" class="biblioref"
role="doc-biblioref" data-xml-rid="r75">75</a>)</td>
</tr>
<tr data-xml-align="center">
<td data-xml-align="left"><span role="math"><span
class="math inline"><em>m</em></span></span></td>
<td>d<sup>−1</sup></td>
<td><span role="math"><span class="math inline">0.01</span></span></td>
<td>Mortality rate</td>
</tr>
<tr data-xml-align="center">
<td data-xml-align="left"><span role="math"><span
class="math inline"><em>p</em></span></span></td>
<td>mm</td>
<td><span role="math"><span class="math inline">0</span></span> to <span
role="math"><span class="math inline">600</span></span></td>
<td>Precipitation rate (<a href="#index.xhtml_r76" class="biblioref"
role="doc-biblioref" data-xml-rid="r76">76</a>)</td>
</tr>
<tr data-xml-align="center">
<td data-xml-align="left"><span role="math"><span
class="math inline"><em>e</em><sub>0</sub></span></span></td>
<td>mmd<sup>−1</sup><span role="math"><span
class="math inline">/</span></span>(gm<sup>−1</sup>)</td>
<td><span role="math"><span class="math inline">0.005</span></span></td>
<td>Max evapotranspiration rate per unit biomass density</td>
</tr>
<tr data-xml-align="center">
<td data-xml-align="left"><span role="math"><span
class="math inline"><em>q</em><sub><em>s</em><em>a</em><em>t</em></sub></span></span></td>
<td>mmd<sup>−1</sup></td>
<td><span role="math"><span class="math inline">800</span></span></td>
<td>Saturated hydraulic conductivity (<a href="#index.xhtml_r70"
class="biblioref" role="doc-biblioref" data-xml-rid="r70">70</a>)</td>
</tr>
<tr data-xml-align="center">
<td data-xml-align="left"><span role="math"><span
class="math inline"><em>c</em></span></span></td>
<td>—</td>
<td><span role="math"><span class="math inline">10</span></span></td>
<td>Deep infiltration exponent (<a href="#index.xhtml_r70"
class="biblioref" role="doc-biblioref" data-xml-rid="r70">70</a>)</td>
</tr>
<tr data-xml-align="center">
<td data-xml-align="left"><span role="math"><span
class="math inline"><em>n</em></span></span></td>
<td>—</td>
<td><span role="math"><span class="math inline">0.4</span></span></td>
<td>Soil porosity (<a href="#index.xhtml_r70" class="biblioref"
role="doc-biblioref" data-xml-rid="r70">70</a>)</td>
</tr>
<tr data-xml-align="center">
<td data-xml-align="left"><span role="math"><span
class="math inline"><em>z</em><sub><em>r</em></sub></span></span></td>
<td>mm</td>
<td><span role="math"><span class="math inline">300</span></span></td>
<td>Herb rooting depth (<a href="#index.xhtml_r70" class="biblioref"
role="doc-biblioref" data-xml-rid="r70">70</a>)</td>
</tr>
<tr data-xml-align="center">
<td data-xml-align="left"><span role="math"><span
class="math inline"><em>d</em></span></span></td>
<td>—</td>
<td>0 to 1</td>
...
<tr data-xml-align="center">
<td data-xml-align="left"><span role="math"><span
class="math inline"><em>S</em><sub><em>h</em></sub></span></span></td>
<td>—</td>
<td><span role="math"><span class="math inline">0.3</span></span></td>
<td>Hygroscopic point (<a href="#index.xhtml_r70" class="biblioref"
role="doc-biblioref" data-xml-rid="r70">70</a>)</td>
</tr>
<tr data-xml-align="center">
<td data-xml-align="left"><span role="math"><span
class="math inline"><em>S</em><sub><em>f</em><em>c</em></sub></span></span></td>
<td>—</td>
<td><span role="math"><span class="math inline">0.6</span></span></td>
<td>Field capacity (<a href="#index.xhtml_r70" class="biblioref"
role="doc-biblioref" data-xml-rid="r70">70</a>)</td>
</tr>
<tr data-xml-align="center">
<td data-xml-align="left"><span role="math"><span
class="math inline"><em>λ</em><sub><em>h</em></sub></span></span></td>
<td>mmd<sup>−1</sup></td>
<td><span role="math"><span class="math inline">−2</span></span></td>
<td>Max tree water provision (<a href="#index.xhtml_r77"
class="biblioref" role="doc-biblioref" data-xml-rid="r77">77</a>)</td>
</tr>
<tr data-xml-align="center">
<td data-xml-align="left"><span role="math"><span
class="math inline"><em>λ</em><sub><em>f</em><em>c</em></sub></span></span></td>
<td>mmd<sup>−1</sup></td>
<td><span role="math"><span class="math inline">10</span></span></td>
...
parameters with typical value ranges <span class="nonlinear-link">(<a
href="t01.xhtml">Table view</a>)</span></figcaption>
</figure>
...
and assimilation differently ([Fig. 1*A*](fig01.xhtml)). In addition,
...
mechanism is disabled by setting [$f_{r}{(S,d)} = 0$]{role="math"},
...
[$f_{a}{(d)}$]{role="math"}, while evapotranspiration is down-regulated
via [$f_{e}{(d)}$]{role="math"}. The shading functions are
[$f_{j}{(d)} = {(1 - d)}^{\beta_{j}}$]{role="math"}, where
[$j = \{ a,e\}$]{role="math"}. [Fig. 1*A*](fig01.xhtml) shows the
...
[$\beta_{e} > \beta_{a}$]{role="math"}.
:::
:::::

:::::::: {#index.xhtml_sec-3-2 .section}
### Root Mechanism.
...
uptake is described by the function [$f_{r}{(S,d)}$]{role="math"}. When
the root mechanism is "on," the canopy mechanism is disabled by setting
[$f_{a}{(d)} = f_{e}{(d)} = 1$]{role="math"}. The expression for the
root function reads:

::::: {#index.xhtml_ueqn1 .display-formula}
:::: {.equation role="math"}
::: inner
$$\begin{array}{r}
{f_{r}{(S,d)} = d\left\lbrack {\lambda_{h} + \varphi\,\text{max}{(0,S - S_{h})} - \varphi\,\text{max}{(0,S - S_{\mathit{fc}})}} \right\rbrack,}
\end{array}$$
:::
::::
:::::
...
::: {role="paragraph"}
where the slope
[$\varphi = {(\lambda_{\mathit{fc}} - \lambda_{h})}/{(S_{\mathit{fc}} - S_{h})}$]{role="math"}.
For [$S$]{role="math"} smaller than the hygroscopic point
[$S_{h}$]{role="math"}, the upper soil is too dry for tree roots to
uptake water, and hydraulic lift reaches its maximum ability to bring
water from deeper soil layers to the topsoil
([$\lambda_{h}$]{role="math"}). For [$S$]{role="math"} greater than the
field capacity [$S_{\mathit{fc}}$]{role="math"}, trees cease to benefit
from increasing soil water content, and uptake water at a rate
[$\lambda_{\mathit{fc}}$]{role="math"}. Between [$S_{h}$]{role="math"}
and [$S_{\mathit{fc}}$]{role="math"}, the root function varies linearly
between [$\lambda_{h}$]{role="math"} and
[$\lambda_{\mathit{fc}}$]{role="math"}. Regardless of soil water
content, the root function depends linearly on tree density
[$d$]{role="math"}. [Fig. 1*B*](fig01.xhtml) shows the function
[$f_{r}$]{role="math"} in the range
[$S_{h} < S < S_{\mathit{fc}}$]{role="math"}, for zero tree density
([$d = 0$]{role="math"}) and maximal tree density
([$d = 1$]{role="math"}).
:::
::::::::

:::: {#index.xhtml_sec-3-3 .section}
### Numerical Solutions.

::: {role="paragraph"}
Numerical analyses were performed with Python 3.12, using the libraries
NumPy 2.0 and SciPy 1.13. Steady-state solutions
([$dB/dt = dS/dt = 0$]{role="math"}) were obtained by finding the roots
of the right-hand side of Eq. [**1**](#index.xhtml_eqn2) with
scipy.optimize.fsolve, using random starting estimates for the roots
([$500 < B < 1,500\;\text{g}\,\text{m}^{- 2}$]{role="math"} and
[$0.5 < S < 0.6$]{role="math"}). A root is accepted when
[$B > 10\;\text{g}\,\text{m}^{- 2}$]{role="math"} and
[$0 < S < 1$]{role="math"}; if these criteria are not met, a new set of
...
numerically integrating Eq. [**1**](#index.xhtml_eqn2) with
...
S12](https://www.pnas.org/doi/10.1073/pnas.2615937123#supplementary-materials).
:::
::::
::::::::::::::::::::::
:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
...
:::: {#index.xhtml_data-availability .section .core-data-availability}
...
Appendix*](https://www.pnas.org/doi/10.1073/pnas.2615937123#supplementary-materials).
:::
::::
