...
def print_paper(data):
    ...
    if "md" in data:
        buttons.append(button(data['md'], "Markdown", "bi-file-earmark-text-fill"))
    if "bib" in data:
...
display(Markdown("### 2026"))
display(HTML("</br>"))
print_paper(yaml_data['feuer2026losses'][0]) 
print_paper(yaml_data['hollander2026mechanisms'][0]) 
print_paper(yaml_data['rez2026stem'][0])
